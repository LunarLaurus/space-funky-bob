"""
Boss Data for Space Funky B.O.B.

Provides boss battle data from INITLEVE.A:fightboss table.
Source-verified: 10 boss battles with HP, sounds, and mechanics.
"""
...
class BossData:
    """Provide boss battle data."""
    
    def __init__(self):
        """Initialize boss data provider."""
    ...
    def get_boss_mechanics(self):
        """
        Get boss battle mechanics.
        
        Returns:
            dict: Boss mechanics documentation
        """
        return BOSS_MECHANICS.copy()
